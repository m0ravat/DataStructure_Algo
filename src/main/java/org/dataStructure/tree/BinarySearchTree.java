...
public class BinarySearchTree {
    ...
    private int successor(TreeNode root) { //find least value below the right child of this root node
        root = root.right;
    ...
    private int predecessor(TreeNode root) {//find greatest value below the left child of this root node
        root = root.left;
